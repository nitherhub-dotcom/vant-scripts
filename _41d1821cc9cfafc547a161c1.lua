-- Protection by Vants
local _KEY="4DTT5-3J463-RA3W9-O603J"
local _ok,_raw=pcall(function()
  return game:HttpGet("https://raw.githubusercontent.com/nitherhub-dotcom/vant-scripts/main/_s1be33512937f6365b455.txt")
end)
...
local discordInvite = "https://discord.gg/SnXQCYzGjx"  -- Popular active server for Steal a Brainrot (trading, giveaways, updates)
